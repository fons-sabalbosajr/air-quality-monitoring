          ...
          <div style={{ flex: 1, overflowY: 'auto' }}>
            ...
            {!collapsed ? (
              <div className="aqm-sider-card" role="note" aria-label="AQI Categories and guidance">
                ...
                <div className="aqm-sider-card-items">
                  <div className="aqm-sider-item">
                    <span className="aqm-sider-dot" style={{ background: '#52c41a' }} />
                  ...
                  <div className="aqm-sider-item">
                    <span className="aqm-sider-dot" style={{ background: '#d4b106' }} />
                    <div className="aqm-sider-text">
                  ...
                  <div className="aqm-sider-item">
                    <span className="aqm-sider-dot" style={{ background: '#fa8c16' }} />
                    <div className="aqm-sider-text">
                  ...
                  <div className="aqm-sider-item">
                    <span className="aqm-sider-dot" style={{ background: '#f5222d' }} />
                    <div className="aqm-sider-text">
                  ...
                  <div className="aqm-sider-item">
                    <span className="aqm-sider-dot" style={{ background: '#722ed1' }} />
                    <div className="aqm-sider-text">
                  ...
                  <div className="aqm-sider-item">
                    <span className="aqm-sider-dot" style={{ background: '#a8071a' }} />
                    <div className="aqm-sider-text">
              ...
              <div className="aqm-sider-tiles" aria-label="AQI legend">
                {[
                  { name: 'GOOD', color: '#52c41a', desc: 'Air quality is considered satisfactory, and air pollution poses little or no risk to public health.' },
                  { name: 'FAIR', color: '#d4b106', desc: 'People with respiratory problems, older adults, and children may experience health effects, but the general public is unlikely to be affected.' },
                  { name: 'UNHEALTHY', color: '#fa8c16', desc: 'People with respiratory disease, such as asthma, should limit outdoor exertion.' },
                  { name: 'VERY UNHEALTHY', color: '#f5222d', desc: 'Everyone may begin to experience adverse health effects, and members of sensitive groups may experience more serious effects.' },
                  { name: 'ACUTELY UNHEALTHY', color: '#722ed1', desc: 'People should limit outdoor exertion. People with heart or respiratory disease such as asthma should stay indoors and rest as much as possible.' },
                  { name: 'EMERGENCY', color: '#a8071a', desc: 'Health alert: everyone may experience serious effects. Avoid outdoor activity and stay indoors with clean, filtered air.' },
                ].map((it) => (
                  <Tooltip key={it.name} placement="right" title={
                    ...
                    <div className="aqm-sider-mini" style={{ background: it.color }} aria-label={it.name} />
                  </Tooltip>
                ))}
              </div>
            )}
